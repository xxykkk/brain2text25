...
from utils import Brain2TextDS
    ...
    def train(self):
        ...
        for epoch in range(self.args['num_epochs']):
            for i, batch in enumerate(self.train_loader):
                ...
                max_len = batch['features_len'].max()
                ...
                with torch.autocast(device_type = "cuda", enabled = self.args['use_amp'], dtype = torch.bfloat16):
                    ...
                    #adjusted_lens = ((adjusted_lens - self.args['model']['patch_size']) / self.args['model']['patch_stride'] + 1).to(torch.int32)
        ...
        for i, batch in tqdm(enumerate(loader), desc = 'Validation'):    
            ...
            with torch.no_grad():
                ...
                for iterIdx, day in enumerate(day_indicies):
                    ...
                    distd = F.edit_distance(decoded_seq, trueSeq)
